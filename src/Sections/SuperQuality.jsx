    ...
    <section id="about-us" className=" flex justify-between items-center max-lg:flex-col gap-10 w-full max-container">
      <div className=" flex flex-1 flex-col">
        ...
        <p className=" mt-4 lg:max-w-lg info-text">
          ...
          innovation and top-notch elegance.
        </p>
        <p className=" mt-6 info-text lg:max-w-lg">Our dedication to details and exellence ensures your satisfaction</p>
        <div className=" mt-11 max-lg:flex max-lg:justify-center max-lg:items-center">
